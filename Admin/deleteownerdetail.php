...
<style type="text/css">
   ...
   &nbsp&nbsp&nbsp&nbsp<h1><i>Delete Owner Details....<i></h1>&nbsp&nbsp
   ...
   <?php
       if(isset($_POST['submit']))
       {
         ...
         {
           mysqli_query($db,"DELETE FROM `ownerdetail` WHERE ownid=$_POST[ownid];");
